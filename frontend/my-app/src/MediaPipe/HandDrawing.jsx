...
const HandDrawing = ({ currentKanji, images, setScore }) => {
  ...
  useEffect(() => {
    ...
    const initializeHandLandmarker = async () => {
      try {
        ...
        setErrorMessage(
          "Failed to initialize hand detection: " + error.message
        );
      }
    };
    ...
    <div className="hand-drawing-container relative">
      ...
      <div className="video-overlay-container">
        ...
        <HandCanvas
          ...
          setScore = {setScore}
        />
        <img className="reference-layer" src={images[currentKanji]} />
      </div>
    </div>
  );
};
